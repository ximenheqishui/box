  ...
  export default {
    ...
    computed: {
      downloadUrl: function () {
        return this.api.exportUrl.areaT + '/?' + qs.stringify(this.lastPostData, { arrayFormat: 'repeat' })
      }
    },
    watch: {
    },
    ...
    methods: {
      ...
      getData (type) {
        ...
        this.api.getAreaT(postdata).then(res => {
          _this.pageLoading = false
          _this.searchLoading = false
          if (res.data.code === 0) {
            _this.resultData = res.data.data.detail1
