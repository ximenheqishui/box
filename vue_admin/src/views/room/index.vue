<template>
  <div class="room">
    ...
    <div class="box">
      <div class="left">
        ...
        <div class="before-head">
          <div class="video-grid " id="video_grid">
            <div id="local_stream" class="video-placeholder video-view">
      ...
      <div class="right">
        <div class="head">治安调解协议书</div>
        <div class="textarea">
          <tinymce ref="tinymce"></tinymce>
        </div>
        <div class="foot">
          <el-button type="primary" size="mini">提交协议</el-button>
        </div>
      </div>
    </div>
  </div>
...
<script>
  import RoomText from '@/views/room/roomText.vue'
    ...
    methods: {
      ...
      initWebRtc (room) {
        ...
        $('#join').on('click', function (e) {
          ...
          console.log('join')
          if (rtc) return
          const userId = _this.$store.getters.userInfo.id
          const roomId = _this.room
  ...
  .room {
    ...
    .box{
      ...
      .left{
        ...
        .video-view, #local_stream, #local_video_info {
          width: 295px;
          height: 200px;
          margin-top: 10px;
        }
